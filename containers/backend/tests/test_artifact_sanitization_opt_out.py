...
def test_get_scan_artifact_unsanitized_forbidden_for_regular_user():
    mock_db = MagicMock()
...
def test_get_scan_artifact_unsanitized_allowed_for_superuser():
    mock_db = MagicMock()
